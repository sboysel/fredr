...
This vignette is intended to introduce the user to fredr functions for the [Sources endpoint](https://research.stlouisfed.org/docs/api/fred/#Sources) of the FRED API.
