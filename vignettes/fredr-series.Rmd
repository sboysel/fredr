...
This vignette is intended to introduce the user to fredr functions for the [Series endpoint](https://research.stlouisfed.org/docs/api/fred/#Series) of the FRED API.
