...
This vignette is intended to introduce the user to fredr functions for the [Releases endpoint](https://research.stlouisfed.org/docs/api/fred/#Releases) of the FRED API.
