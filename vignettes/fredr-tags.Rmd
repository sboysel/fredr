...
This vignette is intended to introduce the user to fredr functions for the [Tags endpoint](https://research.stlouisfed.org/docs/api/fred/#Tags) of the FRED API.
