...
This vignette is intended to introduce the user to fredr functions for the [Categories endpoint](https://research.stlouisfed.org/docs/api/fred/#Categories) of the FRED API.
